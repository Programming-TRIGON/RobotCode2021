...
public class SensorTestCMD extends CommandBase {
    ...
    public SensorTestCMD(RobotConstants.TesterConstants constants, LedSS led, LedConstants ledConstants) {
        addRequirements(led);
        this.led = led;
    ...
    public void end(boolean interrupted) {
        ...
        led.blinkColor(allSuccess ? led.getColorMap().SENSOR_TEST_SUCCESS : led.getColorMap().SENSOR_TEST_FAILURE);
    }
}
