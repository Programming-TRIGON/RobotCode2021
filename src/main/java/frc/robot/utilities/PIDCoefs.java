...
public class PIDCoefs implements Sendable {
     ...
     * @param constraints    constraints for a TrapezoidProfile
     */
    public PIDCoefs(double KP, double KI, double KD, double tolerance, double deltaTolerance, Constraints constraints) {
        this.KP = KP;
        this.KI = KI;
        this.KD = KD;
        this.tolerance = tolerance;
    ...
    public PIDCoefs(double KP, Constraints constraints) {
