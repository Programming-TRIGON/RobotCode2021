...
public abstract class RobotConstants extends RobotMap {
    ...
    public static class swerveConstants {
        public static final FeedbackDevice SWERVE_MODULE_ANGLE_MOTOR_FEEDBACK_DEVICE = FeedbackDevice.CTRE_MagEncoder_Absolute;
        public static final int TALON_FX_TICKS_PER_REVOLUTION = 4096;
        public static final MotorConfig SWERVE_MODULE_SPEED_MOTOR_CONFIG = new MotorConfig();
        public static final MotorConfig SWERVE_MODULE_ANGLE_MOTOR_CONFIG = new MotorConfig();
        public static final PIDCoefs SWERVE_MODULE_SPEED_PID_COEFS = new PIDCoefs(1, 1, 1, 1, 1);
        public static final PIDCoefs SWERVE_MODULE_ANGLE_PID_COEFS = new PIDCoefs(1, 1, 1, 1, 1);
    }
    ...
    public class DrivetrainConstants {
        ...
        public double MAX_ROT_SPEED;
        public MotorConfig ANGLE_MOTOR_CONFIG;
        public MotorConfig SPEED_MOTOR_CONFIG;
