...
public class Robot extends TimedRobot {
  ...
  static private final int MOTOR_PORT = 7, MAG_PORT = 11;
  ...
  public WPI_TalonFX setupWPI_TalonFX(int port, Sides side, boolean inverted) {
    ...
    switch (side) {
      ...
      case LEFT:
        ...
        WPI_TalonSRX srx = new WPI_TalonSRX(MAG_PORT);
        srx.configFeedbackNotContinuous(true, 0);
        leftEncoderPosition = ()-> (double) srx.getSelectedSensorPosition() * encoderConstant;
        leftEncoderRate = ()
          -> (double) srx.getSelectedSensorVelocity() * encoderConstant *
               10;
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(MOTOR_PORT, Sides.LEFT, true);
